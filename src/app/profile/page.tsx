      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-xl shadow-sm p-6 text-center">
            <div className="w-24 h-24 bg-ph-blue/10 rounded-full flex items-center justify-center mx-auto mb-4">
              {user.avatar ? (
                <img
          ...
          <div className="bg-white rounded-xl shadow-sm p-6 mt-6">
            ...
            <form onSubmit={handlePreferencesUpdate}>
              <div className="space-y-3">
                <label className="flex items-center justify-between p-3 bg-gray-50 rounded-lg cursor-pointer">
                  ...
                  <input
                    ...
                    className="w-5 h-5 text-ph-blue rounded"
                  />
                </label>
              ...
              <button
                type="submit"
                disabled={saving}
                className="mt-4 bg-ph-blue text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition disabled:opacity-50"
              >
                {saving ? (
                  <i className="fas fa-spinner fa-spin mr-2"></i>
                ) : (
